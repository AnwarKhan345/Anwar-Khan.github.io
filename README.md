...
#### Contribution:
<p align="justify">
Proposed an transformer-based deep learning algorithm that facilitates the extraction of recurring patterns that constitute a new class of biomarkers with potential prognostic and/or predictive information.  
